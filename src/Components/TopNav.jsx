  ...
  return (
    ...
    <div className="relative z-10 flex items-center justify-between w-full">
      ...
      <div className="flex items-center gap-5">
        ...
        <button onClick={onButtonClick} className="w-[94px] h-[45px] flex items-center text-[13px] justify-center rounded-[40px] text-white bg-gradient-to-r from-[#DE680A] to-[#FEC636] px-[23px] py-[13px] shadow-md">
          Sign Up
        </button>
      </div>
    </div>
